# [观察者模式（Observer Pattern）](https://www.cnblogs.com/zhili/p/ObserverPattern.html)
...
![img](Observer.assets/131222028098360.png)
...
[![复制代码](Observer.assets/copycode.gif)](javascript:void(0);)

　　上面代码是我们进行重构后的实现，重构后的代码实现类图如下所示：

![img](Observer.assets/131347589657826.png)
...
![img](Observer.assets/131432165596549.png)
