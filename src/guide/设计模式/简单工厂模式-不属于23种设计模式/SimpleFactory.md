# [简单工厂模式](https://www.cnblogs.com/zhili/p/SimpleFactory.html)
...
[![复制代码](SimpleFactory.assets/copycode.gif)](javascript:void(0);)
...
![img](SimpleFactory.assets/05170314-a7f4c3e70df3420fa5408c7ccca265d9.png)

## 五、.NET中简单工厂模式的实现

　　介绍完了简单工厂模式之后，我学习的时候就像：.NET类库中是否有实现了简单工厂模式的类呢？后面确实有，.NET中[System.Text.Encoding](http://msdn.microsoft.com/zh-cn/library/system.text.encoding.aspx)类就实现了简单工厂模式，该类中的**[GetEncoding](http://msdn.microsoft.com/zh-cn/library/wzsz3bk3.aspx)(int codepage)**就是工厂方法**，**具体的代码可以通过Reflector反编译工具进行查看，下面我也贴出该方法中部分代码：
...
![img](SimpleFactory.assets/05173548-27a5da55b8434859adb53f386f9c3932.png)

**Encoding**类中实现的简单工厂模式是简单工厂模式的一种演变，此时简单工厂类由抽象产品角色扮演，然而.NET中Encoding类是如何解决简单工厂模式中存在的问题的呢（即如果新添加一种编码怎么办）？在GetEncoding方法里的switch函数有如下代码：
...
本专题中的全部源码：[简单工厂模式源码](https://files.cnblogs.com/zhili/简单工厂模式.rar)